...
point_cloud_range = [-15, -15, -2.4, 15, 15, 0]
occ_size = [200, 200, 16]
use_semantic = False
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/home/datasets/ads_largedata/apa_parking_data/baidu_occ_data/pkl_data/baidu_occ_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file='/home/datasets/ads_largedata/apa_parking_data/baidu_occ_data/pkl_data/baidu_occ_infos_temporal_val.pkl',
...
load_from = '/home/datasets/ads_largedata/tianws/occ/surroundocc/SurroundOcc/work_dirs/surroundocc_nosemantic_navinfo_bak2/epoch_1.pth'
log_config = dict(
    interval=50,
    hooks=[
